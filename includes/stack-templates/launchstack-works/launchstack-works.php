<?php 
/**
 * MP Stacks Template Works
 *
 * @link http://mintplugins.com/doc/
 * @since 1.0.0
 *
 * @package     MP Stacks Template Works
 ...
 */
	 ...
	 /**
	 * Add Works to the list of installed stack templates
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_launchstack_works
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_launchstack_works( $installed_templates ){ 
		
		
		$realpath    = str_replace("\\", "/", dirname(__FILE__));
		$url_path = substr_replace(str_replace($_SERVER['DOCUMENT_ROOT'], '', $realpath), "", 10000);
		
		$installed_templates['mp_stacks_launchstack_works_array'] = array(
			'template_slug' => 'launchstack_works',
	...
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_launchstack_works' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_launchstack_works_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_launchstack_works_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['launchstack_works'] = array( 'title' => 'Works','page_template' => 'default', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'launchstack_theme_bundle_default_stacks', 'mp_stacks_templates_launchstack_works_to_default_stacks' );
	
	/**
	 * This function holds and returns the Works Template Array
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
	 * @return   array The Stack Template Aray
	 */
	function mp_stacks_launchstack_works_array(){ 
	
		$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Launchstack\'s "Works" Stack.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
...
',
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p&gt;Browse through our recent projects below.&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
...
',
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p&gt;This video project called for expertise and professionalism due to its unique angle in its industry. We brought our years of know-how and our cutting edge techniques to the table to bring the message to the forefront in a quick, engaging, and exciting way. On the day of the shoot, the team was well prepared and the job went completely smoothly - resulting in a great edit and a final finished product our client is proud to show off - and so are we!&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
      ...
      'brick_main_image' => 
      array (
        'value' => 'launchstack-video-thumb1.jpg',
        'attachment' => true,
      ),
      'brick_main_image_max_width' => 
      array (
      ...
      'brick_main_image_link_url' => 
      array (
        'value' => 'https://vimeo.com/121500927',
      ),
...
',
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam nunc sem, rutrum vitae rhoncus sit amet, sodales sit amet massa. Fusce vulputate nibh ipsum, a commodo lacus consequat vitae. Proin finibus eu odio ut faucibus. Donec rhoncus ex ac tellus consectetur pellentesque. Aliquam iaculis suscipit arcu, sit amet imperdiet ex tincidunt id. Proin risus ligula, tristique non efficitur nec, facilisis nec nunc. Phasellus id massa et augue rutrum elementum. In a lacinia velit, egestas posuere nisl. Aenean molestie, erat vel efficitur accumsan, neque mauris vulputate sem, vitae pharetra neque orci nec urna.&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
      ...
      'brick_main_image' => 
      array (
        'value' => 'launchstack-video-thumb2.jpg',
        'attachment' => true,
      ),
      'brick_main_image_max_width' => 
      array (
    ...
    array (
      ...
      'brick_main_image' => 
      array (
        'value' => 'launchstack-video-thumb3.jpg',
        'attachment' => true,
      ),
      'brick_main_image_max_width' => 
      array (
...
',
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p&gt;Proin finibus eu odio ut faucibus. Donec rhoncus ex ac tellus consectetur pellentesque. Aliquam iaculis suscipit arcu, sit amet imperdiet ex tincidunt id. Proin risus ligula, tristique non efficitur nec, facilisis nec nunc. Phasellus id massa et augue rutrum elementum. In a lacinia velit, egestas posuere nisl. Aenean molestie, erat vel efficitur accumsan, neque mauris vulputate sem, vitae pharetra neque orci nec urna.s.&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
...
',
      ...
      'brick_main_image' => 
      array (
        'value' => 'launchstack-video-thumb4.jpg',
        'attachment' => true,
      ),
      'brick_main_image_max_width' => 
      array (
