<?php 
/**
 * MP Stacks Template EDD Download
 *
 * @link http://mintplugins.com/doc/
 * @since 1.0.0
 *
 * @package     MP Stacks Template EDD Download
 ...
 */
	 ...
	 /**
	 * Add EDD Download to the list of installed stack templates
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_launchstack_edd_download
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_launchstack_edd_download( $installed_templates ){ 
		
		
		$realpath    = str_replace("\\", "/", dirname(__FILE__));
		$url_path = substr_replace(str_replace($_SERVER['DOCUMENT_ROOT'], '', $realpath), "", 10000);
		
		$installed_templates['mp_stacks_launchstack_edd_download_array'] = array(
			'template_slug' => 'launchstack_edd_download',
			'template_title' => __( 'EDD Download', 'launchstack_theme_bundle' ),
			'template_description' => __('Launchstack\'s "EDD Download" Stack.', 'launchstack_theme_bundle' ),
			'template_tags' => 'Launchstack, EDD Download',
	...
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_launchstack_edd_download' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_launchstack_edd_download_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_launchstack_edd_download_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['download']['launchstack_edd_download'] = array( 'title' => 'EDD Download','post_format' => 'gallery', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'launchstack_theme_bundle_default_stacks', 'mp_stacks_templates_launchstack_edd_download_to_default_stacks' );
	
	/**
	 * This function holds and returns the EDD Download Template Array
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
	 * @return   array The Stack Template Aray
	 */
	function mp_stacks_launchstack_edd_download_array(){ 
	
		$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Launchstack\'s "EDD Download" Stack.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
