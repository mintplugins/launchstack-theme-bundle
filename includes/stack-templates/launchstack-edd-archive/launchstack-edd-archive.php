<?php 
/**
 * MP Stacks Template EDD Archive
 *
 * @link http://mintplugins.com/doc/
 * @since 1.0.0
 *
 * @package     MP Stacks Template EDD Archive
 ...
 */
	 ...
	 /**
	 * Add EDD Archive to the list of installed stack templates
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_launchstack_edd_archive
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_launchstack_edd_archive( $installed_templates ){ 
		
		
		$realpath    = str_replace("\\", "/", dirname(__FILE__));
		$url_path = substr_replace(str_replace($_SERVER['DOCUMENT_ROOT'], '', $realpath), "", 10000);
		
		$installed_templates['mp_stacks_launchstack_edd_archive_array'] = array(
			'template_slug' => 'launchstack_edd_archive',
			'template_title' => __( 'EDD Archive', 'launchstack_theme_bundle' ),
			'template_description' => __('Launchstack\'s "EDD Archive" Stack', 'launchstack_theme_bundle' ),
			'template_tags' => 'Launchstack, EDD Archive',
			'template_preview_img' => $url_path . '/images/preview_thumbnail.jpg',
			'template_demo_url' => 'http://demo.mintplugins.com/launchstack-theme-bundle/launchstack-download-archive/',
		);
		
		return $installed_templates;
	
	}
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_launchstack_edd_archive' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_launchstack_edd_archive_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_launchstack_edd_archive_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['launchstack_edd_archive'] = array( 'title' => 'EDD Archive','page_template' => 'default', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'launchstack_theme_bundle_default_stacks', 'mp_stacks_templates_launchstack_edd_archive_to_default_stacks' );
	
	/**
	 * This function holds and returns the EDD Archive Template Array
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
	 * @return   array The Stack Template Aray
	 */
	function mp_stacks_launchstack_edd_archive_array(){ 
	
		$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Launchstack\'s "EDD Archive" Stack',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
      'brick_title' => 'Download Archive Hero',
      'mp_stack_order' => 1000,
      '_edit_lock' => 
      array (
        'value' => '1422917205:3',
...
',
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p&gt;This template is used to create Download Archives&lt;br /&gt;
from Easy Digital Downloads and show them in Grids.&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
