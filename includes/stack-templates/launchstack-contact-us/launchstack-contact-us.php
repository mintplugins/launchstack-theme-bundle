 ...
 */
	 ...
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_launchstack_contact_us
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_launchstack_contact_us( $installed_templates ){ 
		
		
		$realpath    = str_replace("\\", "/", dirname(__FILE__));
		$url_path = substr_replace(str_replace($_SERVER['DOCUMENT_ROOT'], '', $realpath), "", 10000);
		
		$installed_templates['mp_stacks_launchstack_contact_us_array'] = array(
			'template_slug' => 'launchstack_contact_us',
			'template_title' => __( 'Contact Us', 'launchstack_theme_bundle' ),
			'template_description' => __('Launchstack\'s "Contact Us" Stack.', 'launchstack_theme_bundle' ),
			'template_tags' => 'Launchstack, Contact',
			'template_preview_img' => $url_path . '/images/preview_thumbnail.jpg',
			'template_demo_url' => 'http://demo.mintplugins.com/launchstack-theme-bundle/launchstack-contact-us/',
		);
		
		return $installed_templates;
	
	}
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_launchstack_contact_us' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_launchstack_contact_us_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_launchstack_contact_us_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['launchstack_contact_us'] = array( 'title' => 'Contact Us','page_template' => 'default', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'launchstack_theme_bundle_default_stacks', 'mp_stacks_templates_launchstack_contact_us_to_default_stacks' );
	 ...
	 */
	function mp_stacks_launchstack_contact_us_array(){ 
	
		$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Launchstack\'s "Contact Us" Stack.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
      'brick_title' => 'Contact Page Header',
      'mp_stack_order' => 1000,
      '_edit_lock' => 
      array (
        'value' => '1422762134:1',
...
',
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p&gt;There are a lot of ways to get in touch. Choose your favorite below:&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
      ...
      array (
        ...
        array (
          ...
          array (
            'feature_title' => 
            array (
              'value' => '2943 Sleepy Cider Wood Glenside, California 96198-6506 US',
              'attachment' => false,
            ),
            'feature_icon_type' => 
            array (
          ...
          array (
            ...
            'feature_icon_link' => 
            array (
              'value' => 'mailto:email@emailerson.com',
              'attachment' => false,
            ),
            'feature_icon_link_type' => 
            array (
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'sociallink_icon_link' => 
            array (
              'value' => 'https://facebook.com/mintthemes/',
              'attachment' => false,
            ),
            'sociallink_icon_link_type' => 
            array (
          ...
          array (
            ...
            'sociallink_icon_link' => 
            array (
              'value' => 'http://instagram.com/mintplugins',
              'attachment' => false,
            ),
            'sociallink_icon_link_type' => 
            array (
