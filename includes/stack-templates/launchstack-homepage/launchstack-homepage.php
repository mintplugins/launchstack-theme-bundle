<?php 
/**
 * MP Stacks Template Homepage
 *
 * @link http://mintplugins.com/doc/
 * @since 1.0.0
 *
 * @package     MP Stacks Template Homepage
 ...
 */
	 ...
	 /**
	 * Add Homepage to the list of installed stack templates
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_launchstack_homepage
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_launchstack_homepage( $installed_templates ){ 
		
		
		$realpath    = str_replace("\\", "/", dirname(__FILE__));
		$url_path = substr_replace(str_replace($_SERVER['DOCUMENT_ROOT'], '', $realpath), "", 10000);
		
		$installed_templates['mp_stacks_launchstack_homepage_array'] = array(
			'template_slug' => 'launchstack_homepage',
			'template_title' => __( 'Homepage', 'launchstack_theme_bundle' ),
			'template_description' => __('Launchstack\'s "Homepage" Stack.', 'launchstack_theme_bundle' ),
			'template_tags' => 'Launchstack, Homepage',
	...
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_launchstack_homepage' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_launchstack_homepage_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_launchstack_homepage_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['launchstack_homepage'] = array( 'title' => 'Homepage','is_home' => true,'page_template' => 'default', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'launchstack_theme_bundle_default_stacks', 'mp_stacks_templates_launchstack_homepage_to_default_stacks' );
	
	/**
	 * This function holds and returns the Homepage Template Array
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
	 * @return   array The Stack Template Aray
	 */
	function mp_stacks_launchstack_homepage_array(){ 
	
		$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Launchstack\'s "Homepage" Stack.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
...
',
      ...
      'mailchimp_api_key' => 
      array (
        'value' => '7f2d54dbee4e6b632a7a3bac7d479e41-us8',
      ),
      'mailchimp_list_id' => 
      array (
        'value' => '88f705bd2e',
