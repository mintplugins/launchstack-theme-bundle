 ...
 */
	 ...
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_launchstack_blog
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_launchstack_blog( $installed_templates ){ 
		
		
		$realpath    = str_replace("\\", "/", dirname(__FILE__));
		$url_path = substr_replace(str_replace($_SERVER['DOCUMENT_ROOT'], '', $realpath), "", 10000);
		
		$installed_templates['mp_stacks_launchstack_blog_array'] = array(
			'template_slug' => 'launchstack_blog',
			'template_title' => __( 'Blog', 'launchstack_theme_bundle' ),
			'template_description' => __('Launchstack\'s "Blog" Stack.', 'launchstack_theme_bundle' ),
			'template_tags' => 'Blog, Launchstack',
			'template_preview_img' => $url_path . '/images/preview_thumbnail.jpg',
			'template_demo_url' => 'http://demo.mintplugins.com/launchstack-theme-bundle/blog-archive/',
		);
		
		return $installed_templates;
	
	}
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_launchstack_blog' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_launchstack_blog_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_launchstack_blog_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['launchstack_blog'] = array( 'title' => 'Blog','page_template' => 'default', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'launchstack_theme_bundle_default_stacks', 'mp_stacks_templates_launchstack_blog_to_default_stacks' );
	 ...
	 */
	function mp_stacks_launchstack_blog_array(){ 
	
		$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Launchstack\'s "Blog" Stack.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
...
',
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p&gt;This template is used to create Blog Pages&lt;br /&gt;
