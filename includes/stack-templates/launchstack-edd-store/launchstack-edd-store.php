<?php 
/**
 * MP Stacks Template EDD Store
 *
 * @link http://mintplugins.com/doc/
 * @since 1.0.0
 *
 * @package     MP Stacks Template EDD Store
 ...
 */
	 ...
	 /**
	 * Add EDD Store to the list of installed stack templates
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_launchstack_edd_store
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_launchstack_edd_store( $installed_templates ){ 
		
		
		$realpath    = str_replace("\\", "/", dirname(__FILE__));
		$url_path = substr_replace(str_replace($_SERVER['DOCUMENT_ROOT'], '', $realpath), "", 10000);
		
		$installed_templates['mp_stacks_launchstack_edd_store_array'] = array(
			'template_slug' => 'launchstack_edd_store',
			'template_title' => __( 'EDD Store', 'launchstack_theme_bundle' ),
			'template_description' => __('Launchstack\'s "Store" Stack for Easy Digital Downloads.', 'launchstack_theme_bundle' ),
			'template_tags' => 'EDD, Store, Launchstack',
			'template_preview_img' => plugins_url( '/images/preview_thumbnail.jpg', __FILE__ ),
			'template_demo_url' => 'http://demo.mintplugins.com/launchstack-theme-bundle/edd-archive/',
		);
		
		return $installed_templates;
	
	}
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_launchstack_edd_store' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_launchstack_edd_store_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_launchstack_edd_store_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['launchstack_edd_store'] = array( 'title' => 'EDD Store','page_template' => 'default', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'launchstack_theme_bundle_default_stacks', 'mp_stacks_templates_launchstack_edd_store_to_default_stacks' );
	
	/**
	 * This function holds and returns the EDD Store Template Array
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
	 * @return   array The Stack Template Aray
	 */
	function mp_stacks_launchstack_edd_store_array(){ 
	
		$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Launchstack\'s "Store" Stack for Easy Digital Downloads.',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
...
',
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p&gt;This template is used to create your Storefront&lt;br /&gt;
using Easy Digital Downloads and to display products in Grids.&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
