<?php
/**
 * Installaion Functions for the Launchstack Theme Bundle. This file is standard for any Theme Bundle and should be left alone other than find and replacing.
...
require( LAUNCHSTACK_THEME_BUNDLE_PLUGIN_DIR . 'includes/misc-functions/custom-install-functions.php' );
...
function launchstack_theme_bundle_install() {
	...
	$mp_core_options['mp_stacks_theme_bundle_being_installed'] = array( 
		'theme_bundle_slug' => 'launchstack_theme_bundle',
		'fancy_title' => 'Launchstack Theme Bundle',
		'support_url' => 'https://mintplugins.com/support/launchstack-theme-bundle-support/',
		'support_email' => 'support@mintplugins.com',
		'required_theme_dirname' => apply_filters( 'launchstack_theme_bundle_required_theme_dirname', 'knapstack' ),
...
function launchstack_theme_bundle_admin_init(){
	...
	//Set up the auto redirects to install dependant plugins
	global $mp_core_options, $launchstack_theme_bundle_installation_routine;
 ...
 */
function launchstack_theme_bundle_initialize_default_items_setup( $mp_core_options, $theme_bundle_slug ){
	
	if ( $theme_bundle_slug == 'launchstack_theme_bundle' ){
...
add_filter( 'mp_core_parent_plugin_installation_complete_filter', 'launchstack_theme_bundle_initialize_default_items_setup', 10, 2 );
 ...
 * @return   void
 */
function launchstack_theme_bundle_switch_theme_workaround(){		
	...
	$fancy_theme_name = apply_filters( 'launchstack_theme_bundle_fancy_theme_name', NULL );
